...
<header class="menu">
    ...
    <div class="headerDiv">
        ...
        <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
...
<main>
    ...
    <div class="mainDiv">
        ...
        <a href="index.php"><img class="mainIcon" src="img/search.png" alt="Área de buscar"></a>
        <h2>BUSCAR</h2>
    </div>
    <div class="mainDiv">
